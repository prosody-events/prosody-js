...
| `stateRecoveryDelaySeconds` / `PROSODY_STATE_RECOVERY_DELAY` | Deprecated and ignored. Keyed-state recovery needs no delay. Setting the option emits a `DeprecationWarning`. Remove it    | (none)                                                                              |
