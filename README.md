...
| `stateReadCacheSize` / `PROSODY_STATE_READ_CACHE_SIZE` | Capacity of the published-state read-through cache; accepts sizes such as `1 MiB` | owned cache size, then 1 MiB |
