...
**All code comments, technical documentation, READMEs, and plans must conform
to ASD-STE100 (Simplified Technical English).** Apply these primary STE rules
in everything you write for this project:
